...
function buff_110_add(battleid, unitid, buffinstid,data) 
	...
	sys.log("buff_110_add  添加增伤buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
end
...
function buff_110_update(battleid, buffinstid, unitid)	
	...
	sys.log("buff_110_update  更新增伤buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid)
...
function buff_110_delete(battleid, unitid, buffinstid,data)
	...
	sys.log("buff_110_delete  删除增伤buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
