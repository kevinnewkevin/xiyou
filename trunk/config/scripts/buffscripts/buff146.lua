...
function buff_146_add(battleid, unitid, buffinstid, data) 
	...
	sys.log("buff_146_add  添加 加物理属性 buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
end
...
function buff_146_update(battleid, buffinstid, unitid)	
	...
	sys.log("buff_146_update  更新 加物理属性buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid)
end
...
function buff_146_delete(battleid, unitid, buffinstid, data)
	...
	sys.log("buff_146_delete  删除 加物理属性buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
