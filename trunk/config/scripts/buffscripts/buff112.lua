...
function buff_112_add(battleid, unitid, buffinstid, data) 
	...
	sys.log("buff_112_add  添加减物理防御buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
end
...
function buff_112_update(battleid, buffinstid, unitid)	
	...
	sys.log("buff_112_update  更新减物理防御buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid)
end
...
function buff_112_delete(battleid, unitid, buffinstid, data)
	...
	sys.log("buff_112_delete  删除减物理防御buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
