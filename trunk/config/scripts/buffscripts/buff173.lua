...
function buff_173_add(battleid, unitid, buffinstid,data) 
	...
	sys.log("buff_173_add  添加 加速buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
end
...
function buff_173_update(battleid, buffinstid, unitid)	
	...
	sys.log("buff_173_update  更新加速buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid)
	
end

function buff_173_delete(battleid, unitid, buffinstid,data)
	...
	sys.log("buff_173_delete  删除加速buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
