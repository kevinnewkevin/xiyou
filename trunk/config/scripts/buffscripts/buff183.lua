...
function buff_183_add(battleid, unitid, buffinstid, data) 
	--sys.log("buff_147_add "..","..battleid..","..buffinstid..","..unitid)
	Player.ChangeUnitProperty(battleid, unitid, data, "CPT_MAGIC_ATK")  --加属性值  法术
	sys.log("buff_183_add  添加 增加法术属性 buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
end

function buff_183_update(battleid, buffinstid, unitid)	
	buff_id = 183 --配置表中的buffid
...
function buff_183_delete(battleid, unitid, buffinstid, data)
	...
	sys.log("buff_183_delete  删除 增加法术属性buff"..",battleid是"..battleid..",buffid是"..buffinstid..",目标"..unitid..",数据是"..data)
