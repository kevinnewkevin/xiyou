...
function SK_111_Action(battleid, casterid)
	...
	local  truedamage  = Player.GetMagicDamage(battleid,casterid,t)        --伤害 公式(法术的伤害）
	
	sys.log("SK_111_Action 的伤害"..truedamage)
	...
	Battle.AddBuff(battleid,casterid,t, 104, 0)  -- casterid 单元id    t buff实例id 单体1回合无法行动
