...
type SGE_DBBattleReport struct{
  sync.Mutex
  Battleid int32  //0
  Round int32  //1
  Type int32  //2
...
func (this *SGE_DBBattleReport)SetBattleid(value int32) {
  this.Lock()
  defer this.Unlock()
  this.Battleid = value
}
func (this *SGE_DBBattleReport)GetBattleid() int32 {
  this.Lock()
  defer this.Unlock()
  return this.Battleid
}
func (this *SGE_DBBattleReport)SetRound(value int32) {
  this.Lock()
  defer this.Unlock()
  this.Round = value
}
func (this *SGE_DBBattleReport)GetRound() int32 {
  this.Lock()
  defer this.Unlock()
  return this.Round
}
func (this *SGE_DBBattleReport)SetType(value int32) {
  this.Lock()
  defer this.Unlock()
  this.Type = value
}
func (this *SGE_DBBattleReport)GetType() int32 {
  this.Lock()
  defer this.Unlock()
  return this.Type
}
func (this *SGE_DBBattleReport)SetWinner(value int64) {
  this.Lock()
  defer this.Unlock()
  this.Winner = value
}
func (this *SGE_DBBattleReport)GetWinner() int64 {
  this.Lock()
  defer this.Unlock()
  return this.Winner
}
func (this *SGE_DBBattleReport)SetPlayers(value []COM_ReportCamp) {
  this.Lock()
  defer this.Unlock()
  this.Players = value
}
func (this *SGE_DBBattleReport)GetPlayers() []COM_ReportCamp {
  this.Lock()
  defer this.Unlock()
  return this.Players
}
func (this *SGE_DBBattleReport)SetDefinePos(value []COM_BattleUnit) {
  this.Lock()
  defer this.Unlock()
  this.DefinePos = value
}
func (this *SGE_DBBattleReport)GetDefinePos() []COM_BattleUnit {
  this.Lock()
  defer this.Unlock()
  return this.DefinePos
}
func (this *SGE_DBBattleReport)SetReport(value []COM_BattleReport) {
  this.Lock()
  defer this.Unlock()
  this.Report = value
}
func (this *SGE_DBBattleReport)GetReport() []COM_BattleReport {
  this.Lock()
  defer this.Unlock()
  return this.Report
}
func (this *SGE_DBBattleReport)Serialize(buffer *bytes.Buffer) error {
  this.Lock()
  defer this.Unlock()
  //field mask
  mask := newMask1(1)
...
func (this *SGE_DBBattleReport)Deserialize(buffer *bytes.Buffer) error{
  this.Lock()
  defer this.Unlock()
  //field mask
...
func (this *SGE_DBBattleReport)String() string{
