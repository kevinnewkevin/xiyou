...
func (this *COM_Chat)SetRecordId(value int64) {
  this.Lock()
  defer this.Unlock()
  this.RecordId = value
}
func (this *COM_Chat)GetRecordId() int64 {
  this.Lock()
  defer this.Unlock()
...
func (this *COM_Chat)Serialize(buffer *bytes.Buffer) error {
  ...
  {
    if(this.RecordId!=0){
      err := write(buffer,this.RecordId)
      if err != nil{
        return err
      }
    }
