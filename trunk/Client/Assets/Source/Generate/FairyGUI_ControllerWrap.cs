...
public class FairyGUI_ControllerWrap
{
	...
	static int get_selectedPage(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index selectedPage on a nil value" : e.Message);
		}
	}
	...
	static int get_previsousIndex(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index previsousIndex on a nil value" : e.Message);
		}
	}
	...
	static int get_previousPage(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index previousPage on a nil value" : e.Message);
		}
	}
