...
public class FairyGUI_UIPackageWrap
{
	...
	static int AddPackage(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(byte[]), typeof(string), typeof(FairyGUI.UIPackage.LoadResource)))
			{
				byte[] arg0 = ToLua.CheckByteBuffer(L, 1);
				string arg1 = ToLua.ToString(L, 2);
				FairyGUI.UIPackage.LoadResource arg2 = null;
				LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

				if (funcType3 != LuaTypes.LUA_TFUNCTION)
				{
					 arg2 = (FairyGUI.UIPackage.LoadResource)ToLua.ToObject(L, 3);
				}
				else
				{
					LuaFunction func = ToLua.ToLuaFunction(L, 3);
					arg2 = DelegateFactory.CreateDelegate(typeof(FairyGUI.UIPackage.LoadResource), func) as FairyGUI.UIPackage.LoadResource;
				}
	...
	static int CreateObjectFromURL(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(FairyGUI.UIPackage.CreateObjectCallback)))
			{
				string arg0 = ToLua.ToString(L, 1);
				...
				if (funcType2 != LuaTypes.LUA_TFUNCTION)
				{
					 arg1 = (FairyGUI.UIPackage.CreateObjectCallback)ToLua.ToObject(L, 2);
				}
				else
				{
					LuaFunction func = ToLua.ToLuaFunction(L, 2);
	...
	static int GetItemAsset(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(FairyGUI.UIPackage), typeof(FairyGUI.PackageItem)))
			{
				FairyGUI.UIPackage obj = (FairyGUI.UIPackage)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(FairyGUI.UIPackage), typeof(string)))
			{
				FairyGUI.UIPackage obj = (FairyGUI.UIPackage)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
				object o = obj.GetItemAsset(arg0);
