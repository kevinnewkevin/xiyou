...
public class UIManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("HideMessageBox", HideMessageBox);
	...
	static int ShowMessageBox(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			FairyGUI.Window o = UIManager.ShowMessageBox();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int HideMessageBox(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
	...
	static int GetWindow(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			FairyGUI.Window o = UIManager.GetWindow(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch(Exception e)
