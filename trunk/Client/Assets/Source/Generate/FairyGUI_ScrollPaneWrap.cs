...
public class FairyGUI_ScrollPaneWrap
{
	...
	static int get_footer(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index footer on a nil value" : e.Message);
		}
	}
	...
	static int get_pageMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index pageMode on a nil value" : e.Message);
		}
	}
	...
	static int get_pageController(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index pageController on a nil value" : e.Message);
		}
	}
