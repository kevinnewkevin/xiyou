...
public class FairyGUI_GListWrap
{
	...
	static int get_columnCount(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index columnCount on a nil value" : e.Message);
		}
	}
	...
	static int get_selectionController(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index selectionController on a nil value" : e.Message);
		}
	}
	...
	static int get_touchItem(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index touchItem on a nil value" : e.Message);
		}
	}
